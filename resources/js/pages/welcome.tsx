...
// When registration is disabled, this module isn't generated by Wayfinder.
// We use a safe fallback + @vite-ignore so the build doesn't fail.
...
export default function Welcome() {
    const { auth, registrationEnabled = true } = usePage().props;
